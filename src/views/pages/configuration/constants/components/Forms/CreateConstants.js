...
import { createConstants } from 'store/thunk/configuration/constants.thunk';

function CreateConstants({ dispatch, isMobileDevice, openModal, setOpenModal, theme }) {
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            dispatch(createConstants(values));
