...
import { createPlayer, getStoreList, updatePlayer } from 'store/thunk/player.thunk';

function UpdatePlayerForm({ dispatch, onClose, openModal, playerIndex, players, agentPermissions }) {
    ...
    return (
        <Box style={{ display: 'flex', flexDirection: 'column' }}>
            <form noValidate onSubmit={formik.handleSubmit} onReset={formik.handleReset}>
                ...
                {agentPermissions.includes('UPDATE_PASSWORD_PLAYER') && (
                    <Grid container>
